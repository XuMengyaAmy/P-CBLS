...
# # for DANN (Domain Adversarial Neural Network)
...
def evaluate_metrics(model, dataloader, text_field):
    ...
    if not os.path.exists('PCBLS_predicted_caption'):
        os.makedirs('PCBLS_predicted_caption')
    json.dump(gen, open('PCBLS_predicted_caption/LS_predict_caption_val.json', 'w'))
    # json.dump(gts, open('PCBLS_predicted_caption/GT_val.json', 'w'))
