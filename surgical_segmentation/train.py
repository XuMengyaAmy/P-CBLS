...
def main():
    ...
    arg('--method', type=str, default='baseline', choices=['baseline', 'cbls', 'cbsvls', 'p-cbls', 'p-cbsvls', 'linear_cbls', 'mixture', 'cbls_cbsvls'])
    ...
    if args.method == 'baseline' or args.method == 'cbls' or args.method == 'cbsvls' or args.method =='linear_cbls' or args.method == 'cbls_cbsvls':
